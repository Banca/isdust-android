...
//			e.printStackTrace();
//		}
	//a.findBookByName("数据结构");
//		a.findBookByISBN("9787121146411");
		//a.analyze_search(b.get_string("http://interlib.sdust.edu.cn/opac/search?rows=10&hasholding=1&searchWay0=marc&q0=&logical0=AND&q=android&searchWay=title&searchSource=reader"));
