...
public class RSACryptUtil {
    ...
    public static String encryptByPublicKey_string(String data, String key) throws Exception {
        String result=Base64.encodeToString(encryptByPublicKey(data.getBytes("UTF-8"), key), Base64.DEFAULT);
